...
<head>
    <title>Detail Data Lengkap Total Akhir Transaksi Pembelian Transaksi Pembelian Makanan(PDF)</title>
...
<body>
    ...
    <div class="card">
        ...
        <hr style="width:75%">
        <div class="card-body">
            <h4>Detail Data Lengkap Total Akhir Transaksi Pembelian Transaksi Pembelian Makanan (PDF)</h4>
