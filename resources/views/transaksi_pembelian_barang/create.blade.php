...
@endsection
@section('judul_sub')
Mencatat Data Transaksi Pembelian Makanan 
@endsection
@section('content')
<div class="h2 mb-3 text-center">Mencatat Data Transaksi Pembelian Makanan</div>
<hr style="width:75%">
<form action="/transaksi-pembelian-barang" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="form-group">
        <label for="exampleFormControlSelect1">Nomer Transaksi Makanan</label>
    ...
    <div class="form-group">
        <label for="exampleFormControlSelect1">Nama Makanan</label>
