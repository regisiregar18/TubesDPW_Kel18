...
@endsection
@section('judul_sub')
Data Daftar Transaksi Pembelian Makanan
@endsection
@section('content')
...
<div class="h2 mb-3 text-center">Data Daftar Transaksi Pembelian Makanan</div>

<hr style="width:75%">
<!-- DataTales Example -->
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Daftar Transaksi Pembelian Makanan</h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table id="example1" class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Nomor Total Akhir Transaksi Makanan</th>
                        <th>Nama Makanan</th>
                        <th>Jumlah</th>
                        <th>Harga Satuan</th>
                        <th>Total Harga</th>
