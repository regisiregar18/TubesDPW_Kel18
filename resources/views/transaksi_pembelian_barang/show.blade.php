...
@endsection
@section('judul_sub')
Detail Data Transaksi Pembelian Makanan
@endsection
@section('content')
<div class="h2 mb-3 text-center">Detail Data Transaksi Pembelian Makanan</div>
<hr style="width:75%">
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <h4 class="card-text"><b>Nama Makanan</b> : {{ $tpembelianb->master_barang->nama_barang }}</h4>
