...
<head>
    <title>PDF Detail Data Daftar Transaksi Pembelian Makanan</title>
...
<body>
    ...
    <div class="card">
        ...
        <hr style="width:75%">
        <div class="card-body">
            <h4>PDF Detail Data Daftar Transaksi Pembelian Makanan</h4>
            <div class="card-text"><b>Nomor Total Akhir Transaksi Makanan</b> :
                {{ $tpembelianb->transaksi_pembelian_id }}
            </div>
            <div class="card-text"><b>Nama Makanan</b> : {{ $tpembelianb->master_barang->nama_barang }}</div>
